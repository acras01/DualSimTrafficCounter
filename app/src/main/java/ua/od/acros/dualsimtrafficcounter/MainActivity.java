    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataReceiver = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                ...
                String rxSpeed = DataFormat.formatData(getAppContext(), intent.getLongExtra(Constants.SPEEDRX, 0));
                String txSpeed = DataFormat.formatData(getAppContext(), intent.getLongExtra(Constants.SPEEDTX, 0));
